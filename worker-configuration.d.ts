/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 5c9528e22e31311ba6dc837df7cbce01)
// Runtime types generated with workerd@1.20260114.0 2025-08-03 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UnitoolsCollabRoom";
	}
	interface Env {
		CODEX_HOME: string;
		UNITOOLS_COLLAB_ROOM: DurableObjectNamespace<import("./src/index").UnitoolsCollabRoom>;
		DB: D1Database;
	}
}
