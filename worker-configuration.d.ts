/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 4b9f82108ca99b9c9e50e40936c4935b)
// Runtime types generated with workerd@1.20260526.1 2026-03-17 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareBindings {
	KV: KVNamespace;
	UNITOOLS_R2: R2Bucket;
	DB: D1Database;
	VECTORIZE_FTS_VOCAB_EMBEDDINGS: VectorizeIndex;
	AI: Ai;
	INVITATION_CODES: string;
	UNITOOLS_EDITORS: DurableObjectNamespace<import("./src/index").YDurableObjects>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INVITATION_CODES">> {}
}
